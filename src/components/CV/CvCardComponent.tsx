...
export default function CvCardComponent({ experience }: IProps) {
  return (
    <div className='w-full my-4 flex flex-col mt-8 ml-4 md:ml-20'>
      <div className='relative top-4 -ml-4 md:-left-16 h-2 w-2 -translate-x-2/4 bg-accent-600 rounded-full '></div>
      <p className='text-md md:text-xl mb-3 text-accent-500 font-light '>
        {experience.position}
      </p>

      <div className='shadow-lg flex flex-col md:flex-row border border-primary-50 md:max-w-2/4 mr-4'>
        {/* <img
