      ...
      {isMobile && !isMobileMenuOpen ? null : (
        <>
          ...
          <div className='flex gap-4'>
            ...
            <button
              onClick={switchTheme}
              className='appearance-none p-3 border border-primary-700 bg-background dark:bg-darkMode-background hover:bg-primary-700  hover:border-primary-700 rounded-full group'
            >
              {theme ? (
                <svg
                  width='16px'
                ...
                >
                  ...
                  >
                    <path
                      ...
                      id='Shape'
                      className='group-hover:fill-accent-500'
                      fill='#eaeded'
                      fillRule='nonzero'
                    ></path>
                  </g>
